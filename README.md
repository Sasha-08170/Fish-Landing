# 🎨 Рыбный Лендинг - Профессиональный сайт

Современный адаптивный лендинг, созданный с использованием методологии БЭМ (Block Element Modifier) и современных веб-технологий.
...
- **CMS интеграция** - подключение к системе управления контентом
